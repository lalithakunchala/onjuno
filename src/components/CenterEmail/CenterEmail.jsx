                    ...
                    <div className="row ml-4">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-6 ">
                            ...
                            <div><h2 className={styles.subText}>Our checking account gives you higher returns<br/>than a savings account with no hidden fees.</h2></div>
                                ...
                                <div className="col-12 col-sm-12 col-md-8 col-lg-12 ml-5 pl-5">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-sm-12 ml-5 pl-5">
                                        <div className="row ml-5">
                                        <div className="col-1  mt-2 ">
                                            ...
                                            <div className="col-8 mt-2">
                                                <h4 className="text-secondary mt-2 text-left">281 spots left for Priority Access </h4>
                                            </div>
                                        </div>
                                    </div>
